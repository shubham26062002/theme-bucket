...
const Searchbar = ({
    ...
    return (
        <div className={twMerge('flex justify-start rounded-full items-center border-[1px] border-brown focus-within:ring-2 ring-yellow-ochre', type === 'mobile' && 'mt-4 mb-8 mx-6')}
            id="searchbar">
            ...
            <input className={twMerge('py-[8.4px] px-4 focus:outline-none text-sm min-w-[320px]', type === 'mobile' && 'block w-full min-w-0')} placeholder={placeholder}
                id={id} />
