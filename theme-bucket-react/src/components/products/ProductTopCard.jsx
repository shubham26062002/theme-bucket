  ...
  return (
    ...
    <Link class="group" to={to}>
                        <div
                            ...
                            <div class="p-4">
                                <h1
                                    class="font-semibold text-neutral-700 whitespace-nowrap overflow-hidden text-ellipsis max-w-full leading-relaxed">
                                    {name}</h1>
                                <p
                                    class="text-xs text-gray-500 whitespace-nowrap overflow-hidden text-ellipsis max-w-full">
                                    by {publisher}</p>
                                <div class="mt-3 flex justify-between items-center">
                                    <div class="flex justify-start items-center gap-1.5">
                                        ...
                                        <span class="text-xs font-light text-neutral-500 leading-none">({ratingscount})</span>
                                    </div>
                                    <p class="font-bold text-lg text-neutral-700">Rs. {price}
                                    </p>
                                </div>
                                <button
